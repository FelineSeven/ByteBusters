...
class CodeWriter:
    ...
    def write_init(self):
        # Escribe el codigo VM bootstrap 
        output = []
        output.append("@256")
        output.append("D=A")
        output.append("@SP")
    ...
    def set_file_name(self, file_name: str):
        # informa a la grabadora de codigo sobre el archivo que se esta procesando.
    ...
    def write_label(self, label: str):
        # Escribe la etiqueta en ensamblador 
    ...
    def write_goto(self, label: str):
        #Escribe un jump sin condicion para la etiqueta 
        label_name = self.function_name + "$" + label
        output = []
        output.append("@" + label_name)
        output.append("0;JMP")
    ...
    def write_if(self, label: str):
        # Escribe un jump con condicion para la etiqueta dada 
        label_name = self.function_name + "$" + label
        output = []
        output.append("@SP")
        output.append("AM=M-1")
    ...
    def write_function(self, function_name: str, num_vars: int):
        # Escribe la definicion de funcion en ensamblador 
        output = []
    ...
    def write_call(self, function_name: str, num_args: int):
        # Escribe el codigo necesario en ensamblador para llamar una funcion 
    ...
    def write_return(self):
        # Escribe el codigo de retorno de una funcion call
        output = []
        output.append("@LCL")
        output.append("D=M")
        output.append("@R13")
    ...
    def write_to_file(self, output: list, new_line=True):
        # Escribe una lista de salida dada 
        # Agrega una linea vacia 
        if new_line:
            output.append("")
        # Escribe cada linea en el archivo de salida 
        for line in output:
...
def main():
    ...
    # Se indica el nombre de el directoria 
    ...
    # Insertar el bootstrap code 
    code_writer.comment("Bootstrap Code")
    code_writer.write_init()

    # Recorrer los archivos de entrada y convertirlos en un unico archivo de ensamblaje 
    for input_file_name in input_files:
        # cambiamos el nombre del code_writer
        file_name = input_file_name.split("/")[-1][:-3]
        code_writer.set_file_name(file_name)

        # Se crea un parser con el archivo de entrada 
        ...
        while parser.hasMoreCommands():
            ...
            # Determine el tipo de comando actual 
